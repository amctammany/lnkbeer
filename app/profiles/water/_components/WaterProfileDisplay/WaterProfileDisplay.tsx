    ...
    >
      <div className="pt-4">
        <Card className="m-4 *:border-b-2 last-of-type:*:border-b-0 ">
          ...
          <Prop label={<Ca2 />} value={src?.calcium} />
          <Prop label={<Cl />} value={src?.chloride} />
          <Prop label={<MgSo4 />} value={src?.magnesium} />
          <Prop label={<SO4 />} value={src?.sulfate} />
          <Prop label={<Na />} value={src?.sodium} />
          <Prop label={<HCO3 />} value={src?.bicarbonate} />
        </Card>
      </div>
      ;
    </AppBarLayout>
